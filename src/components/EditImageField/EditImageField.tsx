...
interface EditImageFieldPropsType {
  defaultImage: string
  uploadTo: string
...
const EditImageField: React.FC<EditImageFieldPropsType> = ({ defaultImage, uploadTo, actionWithUrl, type }: EditImageFieldPropsType) => {
